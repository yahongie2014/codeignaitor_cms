    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ul class="breadcrumb">
          ...
          <li><a href="<?php echo base_url().'admin/rssFeeds/'; ?>"><?php echo lang('rssFeeds'); ?></a></li>
    ...
    <div class="row">
      <div class="col-lg-12">
        <section class="panel">
         <!-- Form Start -->
         <div class="form">
           <form class="cmxform form-horizontal tasi-form" id="signupForm" enctype="multipart/form-data" method="post" action="<?php echo site_url('admin/rssFeeds/form/'.$id)?>">
            <!-- tabbed header -->
          ...
          <!-- tabbed content -->
            <div class="panel-body">
                ...
                <div class="form-group ">
                    ...
                    <?php  if(!empty($image)) { ?>
                    <?php $filename = "application/views/images/upload/rssFeeds/".$image; ?>
                        <div class="col-lg-6">
                    ...
                    elseif ($image!="") { ?>
                        <div class="bs-example bs-example-images">
                        <img src="<?php echo $url; ?>" width="150px" class="img-thumbnail">
                        </div>
                    <?php }
                    } //end if image
                    else {  ?>
              ...
              <div class="col-lg-12 bottom-form-update">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-offset-9 col-lg-3">
                    ...
                    <button class="btn btn-danger" type="button" onclick="window.location = '<?php echo site_url('admin/rssFeeds'); ?>'"><?php echo lang('Cancel'); ?></button>
