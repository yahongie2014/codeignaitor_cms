                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu extended logout">
                        ...
                        <li><a href="<?php echo base_url().'admin/users/update/'. $this->session->userdata('adminId');?>"> <i class=" icon-suitcase"></i><?php echo lang('Profile') ?></a></li>
                         <li class="ar first"><a href="<?php echo site_url('admin/index/set_lang/arabic'); ?>" class="language-link active" lang="ar"><img class="language-icon" src="<?php echo base_url(); ?>img/sa.png" width="16" height="12" alt="Arabic" title="Arabic" /> </a></li>

                          <li class="ge second"><a href="<?php echo site_url('admin/index/set_lang/german'); ?>" class="language-link active" lang="gr"><img class="language-icon" src="<?php echo base_url(); ?>img/gr.png" width="16" height="12" alt="German" title="German" /> </a></li>
                  ...
                  <ul class="sidebar-menu">
                    ...
                    <li <?php if((!empty($admin_menu_coursesContent) && $admin_menu_coursesContent === true) || (!empty($admin_menu_courses) && $admin_menu_courses === true) || (!empty($admin_menu_courses_application) && $admin_menu_courses_application === true)  ) { echo ' class="sub-menu active"'; } else { echo " class='sub-menu'"; } ?> >
                      ...
                      <ul class="sub">
                        ...
                        <li <?php if(!empty($admin_menu_branches) && $admin_menu_branches == true) { echo ' class="active"'; } ?>><a  href="<?php echo base_url(); ?>admin/branches"><?php echo lang('branches'); ?></a></li>
