    ...
    <section class="wrapper">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <ul class="breadcrumb">
            ...
            <?php ?>   <li class="active"><?php echo  lang('feedback');?></li><?php ?>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
         ...
         <?php if($messages != 0){  ?>
         <form class='cmxform form-horizontal tasi-form'  id='newsForm' method='post' action="<?php echo base_url() . 'admin/feedback/deleteMultiple' ?>">
