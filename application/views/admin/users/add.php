      ...
      <div class="col-lg-12">
        <section class="panel">
          <div class="form">
            ...
            <?php
            $attributes = array('class' => 'control-label col-lg-2',);
            ?>
            <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="<?php echo site_url( 'admin/users/add/'.$groupId )?>">
          ...
          <div class="col-lg-12 bottom-form-update">
            <div class="form-group">
              <div class="col-lg-offset-9 col-lg-3">
                ...
                ?>
                <button class="btn btn-danger" type="button" onclick="window.location = '<?php echo site_url('admin/users/index/'.$groupId); ?>'"><?php echo lang( 'Cancel' ) ?></button>
