      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <ul class="breadcrumb">
            ...
            <?php ?>   <li class="active"><?php echo  lang('packages');?></li><?php ?>
         ...
         <section class="panel">
          <header class="panel-heading">
            ...
            <div class="pull-right">
              <a class="btn btn-sm btn-default" href="<?php echo base_url().'admin/packages/form'; ?>"><span class="glyphicon glyphicon-plus"></span> <?php echo lang('form_add'); ?></a>
            </div>
          </header>
              ...
              <tbody>
               ...
               <tr class="odd gradeX">
                ...
                <td>
                  ...
                  <a class="btn btn-sm btn-success" href="<?php echo base_url().'admin/packages/packageData/'.$item->id; ?>"><span class="glyphicon glyphicon-file"></span> <?php echo lang('courses'); ?></a>
  ...
  </section><script src="<?php echo base_url() ?>js/jquery.js"></script>
