      ...
      <div class="col-lg-12">
        <section class="panel">
         ...
         <div class="form">
           ...
           <form class="cmxform form-horizontal tasi-form" id="signupForm" enctype="multipart/form-data" method="post" action="<?php echo site_url( 'admin/packages/course/'.$packageId.'/'.$id)?>">
          ...
          <div class="panel-body">
            ...
            <div class="tab-content">
                    ...
                    <div class="form-group ">
                      <label for="project-title-en" class="control-label col-lg-2"><?php echo lang( 'title' ).' ('.lang('arabic').')'; ?>   *</label>
                      <div class="col-lg-6">
                    ...
                    <div class="form-group ">
                      <label for="project-title-en" class="control-label col-lg-2"><?php echo lang( 'title' ).' ('.lang('german').')'; ?>   *</label>
                      <div class="col-lg-6">
