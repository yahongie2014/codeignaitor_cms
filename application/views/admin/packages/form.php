        ...
        <section class="panel">
         ...
         <div class="form">
          ...
          <?php echo $msg;?></div><?php } //end if $msg  ?>
           ...
           <form class="cmxform form-horizontal tasi-form" id="signupForm" enctype="multipart/form-data" method="post" action="<?php echo site_url( 'admin/packages/form/'.$id); ?>">
                <!-- tabbed header -->
          ...
          <div class="panel-body">
            ...
            <div class="tab-content">
                ...
                <div id="home-36" class="tab-pane active">
                    ...
                    <!-- contentAR -->
                    <div class="form-group ">
                        <label for="contentAR" class="control-label col-lg-2"><?php echo lang('package_content').' ('.lang('arabic').')'; ?>  </label>
                        <div class="col-lg-6">
                ...
                <div id="about-36" class="tab-pane">
                    ...
                    <!-- desc200GE -->
                    <div class="form-group ">
                        <label for="desc200GE" class="control-label col-lg-2"><?php echo lang( 'desc200GE' ); ?>  </label>
                        <div class="col-lg-6">
                    ...
                    <!-- contentGE -->
                    <div class="form-group ">
                        <label for="contentGE" class="control-label col-lg-2"><?php echo lang('package_content').' ('.lang('german').')'; ?>  </label>
                        <div class="col-lg-6">
                   ...
                   <div class="form-group ">
                       ...
                       <?php  if(!empty($image)){ ?>
                       <?php $filename = "application/views/images/upload/packages/".$image; ?>
                           <div class="col-lg-6">
                  ...
                  <div class="col-lg-6">
                     <?php if (!empty($returnedData)) {
                            ...
                            if (!empty($instructorIds)) {
                                $packageInstructors = $instructorIds; //keep selected options
                            }

                            //packageInstructors is an array generated from database.
                            echo form_multiselect('instructorId[]', $instructors, $packageInstructors, 'class="form-control"');
                      } else {
                            //if form validation fails
                            $instructorIds = $this->input->post('instructorId');
                            if(!empty($instructorIds)) {
            ...
            <div class="col-lg-12 bottom-form-update">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-offset-9 col-lg-3">
                  ...
                  <button class="btn btn-danger" type="button" onclick="window.location = '<?php echo site_url('admin/packages'); ?>'"><?php echo lang( 'Cancel' ); ?></button>
