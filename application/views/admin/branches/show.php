        ...
        <div class="col-lg-12">
          ...
          <ul class="breadcrumb">
            ...
            <li><a href="<?php echo site_url('admin'); ?>"><i class="icon-dashboard"></i><?php echo lang('home'); ?></a></li>
               ...
               <li class="active"><?php echo  lang('branches');?></li>
         ...
         <section class="panel">
          <header class="panel-heading">
            ...
            <div class="pull-right">
              <a class="btn btn-sm btn-default" href="<?php echo base_url().'admin/branches/form'; ?>"><span class="glyphicon glyphicon-plus"></span> <?php echo lang('form_add'); ?></a>
                    ...
                    <table class="table table-striped border-top" id="sample_1">
                      ...
                      <tbody>
                       ...
                       <tr class="odd gradeX">
                        ...
                        <td><?php echo $i; ?></td>
                        <td><?php  if(!empty($item->titleAR)) echo $item->titleAR; ?></td>
                        ...
                        <td>
                          ...
                          <a class="btn btn-sm btn-info" href="<?php echo base_url().'admin/branches/form/'.$item->id; ?>"><span class="glyphicon glyphicon-cog"></span> <?php echo lang('edit'); ?></a>

                            <?php if (!empty($item->applications)) { ?>
                          <a class="btn btn-sm btn-warning" href="<?php echo base_url().'admin/branches/applications/'.$item->id; ?>"><span class="glyphicon glyphicon-file"></span> <?php echo lang('trainees'); ?></a>
                          <?php } //if applications ?>

                          <a class="btn btn-sm btn-danger" href="<?php echo base_url().'admin/branches/delete/'.$item->id; ?>"  onClick="return Del_Confirm(); "><span class="glyphicon glyphicon-trash"></span> <?php echo lang('list_delete'); ?></a></td>
                        </tr>
                        <?php } ?>
