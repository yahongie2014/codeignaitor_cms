         ...
         <section class="panel">
          <header class="panel-heading">
            ...
            <div class="pull-right">
              <a class="btn btn-sm btn-default" href="<?php echo base_url().'admin/branchesCourse/form'; ?>"><span class="glyphicon glyphicon-plus"></span> <?php echo lang('form_add'); ?></a>
                      ...
                      <tbody>
                       ...
                       <tr class="odd gradeX">
                        ...
                        <td>
                          ...
                          <a class="btn btn-sm btn-info" href="<?php echo base_url().'admin/branchesCourse/form/'.$item->id; ?>"><span class="glyphicon glyphicon-cog"></span> <?php echo lang('edit'); ?></a>

                          <a class="btn btn-sm btn-danger" href="<?php echo base_url().'admin/branchesCourse/delete/'.$item->id; ?>"  onClick="return Del_Confirm(); "><span class="glyphicon glyphicon-trash"></span> <?php echo lang('list_delete'); ?></a></td>
                        </tr>
                        <?php } ?>
