        ...
        <div class="col-lg-12">
          ...
          <ul class="breadcrumb">
            <li><a href="<?php echo site_url('admin'); ?>"><i class="icon-dashboard"></i><?php echo lang('home'); ?></a></li>
               <li class="active"><?php echo  lang('trainees');?></li>
          </ul>
          <!--breadcrumbs end -->
        </div>
      </div>
         ...
         <section class="panel">
          <header class="panel-heading">
            ...
            <div class="pull-right">
              <a class="btn btn-sm btn-default" href="<?php echo base_url().'admin/trainees/form'; ?>"><span class="glyphicon glyphicon-plus"></span> <?php echo lang('form_add'); ?></a>
          ...
          <form class='cmxform form-horizontal tasi-form'  id='form11' method='post' action="<?php echo base_url() . 'admin/trainees/delete' ?>">
              ...
              <tbody>
               ...
               <tr class="odd gradeX">
                ...
                <td>
                  ...
                  <a class="btn btn-sm btn-success" href="<?php echo base_url().'admin/trainees/applications/'.$item->id; ?>"><span class="glyphicon glyphicon-file"></span> <?php echo lang('applications'); ?></a>

                  <a class="btn btn-sm btn-info" href="<?php echo base_url().'admin/trainees/form/'.$item->id; ?>"><span class="glyphicon glyphicon-cog"></span> <?php echo lang('edit'); ?></a>

                  <a class="btn btn-sm btn-danger" href="<?php echo base_url().'admin/trainees/delete/'.$item->id; ?>"  onClick="return Del_Confirm(); "><span class="glyphicon glyphicon-trash"></span> <?php echo lang('list_delete'); ?></a>
                </td>
                </tr>
                <?php } ?>
