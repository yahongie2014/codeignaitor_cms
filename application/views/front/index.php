    ...
    <div class="row home-courses">
            ...
            <div class="filter-item2 a1 col-lg-4 col-md-4 col-sm-8 col-xs-12 course inviewport animated delay2">
                <div class="pic">
                    ...
                    <ul class="social">
                            <li>
                                <?php if(!empty($course->duration)) echo $course->duration; ?><?php if($course->duration == 2){echo lang('2clocks');}elseif($course->duration == 1){echo lang('clock');}elseif($course->duration >= 11){echo lang('clock');}else{echo lang('clocks');}?>
                            </li>
                            <li class="fees">
                                <?php if(!empty($course->price)) echo $course->price; ?> <?=lang('LE');?>
                            </li>
                    </ul>
                </div>
                <div class="info">
        ...
        <!-- Blog Image - End -->
            <!-- Blog Info - Start -->
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 inviewport animated delay1" data-effect="fadeIn">
                    <div class="info">
                        <span class="date"><?php if(!empty($post->addingDate)) echo  ($post->addingDate); ?></span>
                        ...
                        <a class="btn btn-primary text-on-primary"  href="<?php echo base_url().'blog/'.$post->id; ?>"><?php echo lang('read_more'); ?></a>
                    </div>
                </div>
        <!-- Blog Info - End -->
...
<section class="parallax twitter" id="twitter" style=" background-image: url('img/banner-1.jpg'); position: relative; overflow: hidden; background-size: cover; background-position: center center;" >
    ...
    <div class="container">
        <div class="row">
            <h1 class="heading"><?=lang('testimonials');?> </h1>
            <div class="headul"></div>
