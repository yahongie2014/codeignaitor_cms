    ...
    <div class="container">
        <div class="row">
            ...
            <div class="filter-categories filter-mixitup">
                <span class="btn filter " data-filter="all"><?= lang('allCourses');?></span>
                ...
                <div class="filter-item2 a<?php if(!empty($item->categoryId)) echo $item->categoryId; ?> col-lg-4 col-md-4 col-sm-8 col-xs-12 course inviewport animated delay2">
                    <div class="pic">
                        ...
                        <ul class="social">
                            ...
                            <li>
                                <?php echo $item->duration; ?><?php  if($item->duration == 2){echo lang('2clocks');}elseif($item->duration == 1){echo lang('clock');}elseif($item->duration >= 11){echo lang('clock');}else{echo lang('clocks');} ?>
                            </li>
                            <?php }  ?>
