...
<body class=" angled  yellow">
 ...
 <li class="ar first"><a href="<?php echo site_url('index/set_lang/arabic'); ?>" class="language-link active" lang="ar"><img class="language-icon" src="<?php echo base_url(); ?>img/sa.png" width="16" height="12" alt="Arabic" title="Arabic" /> </a></li>
                            <li class="ge second"><a href="<?php echo site_url('index/set_lang/german'); ?>" class="language-link active" lang="gr"><img class="language-icon" src="<?php echo base_url(); ?>img/gr.png" width="16" height="12" alt="German" title="German" /> </a></li>
                    ...
                    <div class='cssmenu'>
                        ...
                        <ul class='menu-ul'>
                            ...
                            <li class='has-sub'>
                                ...
                                <ul>
                                    <li>
                                        <a href='<?php echo base_url().'feedback'; ?>'><?php echo lang('front_feedback'); ?></a>
                                    </li>
                                </ul>
                            </li>
