                ...
                foreach ($news as $post) { $i++;
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 blog blog_altered blog_left">
                        <div class="row">
                            ...
                            <div class=" col-lg-6 col-md-6 col-sm-10 col-xs-12  pic inviewport animated delay1" data-effect="fadeIn">
                                                            ...
                                                            <img src="<?php echo base_url().'/img/uploads/auto.jpg'; ?>" class="img-responsive" alt="<?php if(!empty($post->title)) echo $post->title; ?>" title="<?php if(!empty($post->title)) echo $post->title; ?>">
                                                            </div>
                                                        ...
                                                        <?php $filename = "application/views/images/upload/rssFeeds/".$post->image;
                                                         if ( $post->image!="" && file_exists( "$filename" ) ) { ?>
                                                            <div class="bs-example bs-example-images">
                                                            <img src="<?php echo $post->image; ?>" class="img-responsive" alt="<?php if(!empty($post->title)) echo $post->title; ?>" title="<?php if(!empty($post->title)) echo $post->title; ?>">
                                                            </div>
                                                        <?php  }//end file_exists
                                                        elseif ($post->image!="") { ?>
                                                            <div class="bs-example bs-example-images">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 inviewport animated delay1" data-effect="fadeIn">
                                <div class="info">
                                    <span class="date"><?php if(!empty($post->pubDate)) echo $post->pubDate; ?></span>
                                    ...
                                    <a class="btn btn-primary text-on-primary" target="_blank" href="<?php if(!empty($post->description)) echo $post->url; ?>"><?php echo lang('read_more'); ?></a>
                                </div>
                            </div>
                            <!-- Blog Info - End -->
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 blog blog_altered blog_right">
                        ...
                        <div class=" col-lg-6 col-md-6 hidden-sm hidden-xs  pic inviewport animated delay1" data-effect="fadeIn">
                                                            ...
                                                            <div class="bs-example bs-examp    le-images">
                                                            <img src="<?php echo base_url().'/img/uploads/auto.jpg'; ?>" class="img-responsive" alt="<?php if(!empty($post->title)) echo $post->title; ?>" title="<?php if(!empty($post->title)) echo $post->title; ?>">
                                                            </div>
