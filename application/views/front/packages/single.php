...
<section class='padding-bottom-25 padding-top-25'>
    ...
    <div class="container">
        <div class="row">
            <h1 class="heading"><?php if(!empty($package->title)) echo $package->title; ?></h1>
            ...
            <div class="col-lg-8 col-lg-offset-0  col-md-8 col-md-offset-0 col-sm-8 col-sm-offset-0 col-xs-10 col-xs-offset-1 inviewport animated delay3" data-effect="fadeInUp">
                <div class="box_style_1">
                    <?php  if(!empty($package->content)) { ?>
                        <h2><?php echo lang('front_package_content'); ?></h2>
                        <p>
                ...
                <div class="box_style_1">
                    <ul class="course-data">
                        ...
                        <li>
                            <i class="fa fa-clock-o"></i> <?php echo $package->duration; ?>
                        </li>
                        <?php } ?>
                        <?php  if(!empty($package->weeksNum)) { ?>
                        <li>
                            <i class="fa fa-calendar"></i> <?php echo $package->weeksNum; ?>
                        </li>
                        <?php } ?>
                        <?php if(!empty($package->lecturesNum)) { ?>
                        <li>
                            <i class="fa fa-pencil"></i> <?php echo $package->lecturesNum; ?>
                        </li>
                        <?php } ?>
                    </ul>
                </div>
                ...
                <div class="box_style_1">
                    ...
                    <h4><?php echo lang('course_fees'); ?>:<span><?php echo $package->price; ?> <i><?= lang('LE');?></i></span> </h4>
                    <?php } ?>
                    <p><?php echo lang('payment_options'); ?></p>
                    <ul class="course-data">
                        <li>
                            <a class="btn btn-primary modalLink1" data-toggle="modal" href="#paypalModal" data-id="<?php if(!empty($package->id)) echo $package->id; ?>" ><?= lang('paypal'); ?></a>
                            <!-- <a href="" class="btn btn-primary"> <i class="fa fa-paypal payments"></i> Paypal</a> -->
                        </li>
                        <li>
                            <a class="btn btn-primary modalLink" data-toggle="modal" href="#viewForm" data-id="<?php if(!empty($package->id)) echo $package->id; ?>" ><?php echo lang('book_pay_later'); ?></a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-lg-4 col-lg-offset-0 col-md-4 col-md-offset-0 col-sm-4 col-sm-offset-0 col-xs-10 col-xs-offset-1 inviewport animated delay3" data-effect="fadeInUp">
                ...
                <div class="box_style_1">
                    <?php if(!empty($package->instructors)) { ?>
                    <h4><?php echo lang('front_instructors'); ?></h4>
                    <?php foreach ($package->instructors as $item) { ?>
                    <div class="media">
                    ...
                    <h4><?php echo lang('front_package_courses'); ?></h4>
                    <ul class="list_1">
                        <?php $i = 0; foreach ($package->courses as $item) {  $i++;
                            if (!empty($i) && $i <= 4) {  ?>
                          <li><a href="#"><?php if(!empty($item->title)) echo $item->title; ?></a></li>
                        <?php } //end if i ?>
                        <?php } //end foreach package->courses ?>
                    </ul>
                    <?php } //end if package->courses ?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="width: 100% !important;  padding-right: 0px !important;">
              ...
              <div id="order-result1"></div>
                <form action="<?php echo base_url().'packages/apply/'.$package->id.'/paypal'; ?>" method="post" target="_top" id="paypalForm">
                ...
                <form action="<?php if(!empty($paypalUrl)) echo $paypalUrl; ?>" method="post" target="_top" id="paypalForm1">
                   ...
                   <input type="hidden" name="item_name" value="<?php if(!empty($package->title)) echo $package->title; ?>">
                   <input type="hidden" name="amount" value="<?php if(!empty($package->price)) echo $package->price; ?>">
                   <input type="hidden" name="currency_code" value="USD">

                  <input type="hidden" name="return" value="<?php echo base_url().'packages/'.$package->id; ?>">
                  <input type="hidden" name="cancel_return" value="<?php echo base_url().'packages/'.$package->id; ?>">
                  <input type="hidden" name="notify_url" value="<?php echo base_url().'packages/ipn'; ?>">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" style="width: 100% !important;  padding-right: 0px !important;">
              ...
              <!-- Form - Start -->
              <form action='<?php echo base_url().'packages/apply/'.$package->id; ?>' method='post' id="quoteForm">
                ...
                <button type='submit' class='btn btn-block btn-primary transition' id='sendBtn'><?php echo lang('send_message'); ?></button>
              </form>
              <!-- Form - End -->
