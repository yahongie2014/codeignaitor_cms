        ...
        <div class="col-lg-12">
          ...
          <ul class="breadcrumb">
            ...
            <li><a href="<?php echo base_url().'admin/videos/'; ?>"><?php echo lang( 'gallery' ); ?></a></li>
               ...
               <li class="active"><?php echo  lang('videos');?></li>
          </ul>
          <!--breadcrumbs end -->
        </div>
      </div>
         ...
         <section class="panel">
          <header class="panel-heading">
            ...
            <div class="pull-right">
              <a class="btn btn-sm btn-default" href="<?php echo base_url().'admin/videos/video/'.$galleryId; ?>"><span class="glyphicon glyphicon-plus"></span> <?php echo lang('form_add'); ?></a>
            </div>
          </header>
              ...
              <tbody>
               ...
               <tr class="odd gradeX">
                ...
                <td>
                  ...
                  <a class="btn btn-sm btn-info" href="<?php echo base_url().'admin/videos/video/'.$galleryId.'/'.$item->id; ?>"><span class="glyphicon glyphicon-cog"></span> <?php echo lang('edit'); ?></a>

                  <a class="btn btn-sm btn-danger" href="<?php echo base_url().'admin/videos/delete/'.$item->id.'/video/'.$galleryId; ?>"  onClick="return Del_Confirm(); "><span class="glyphicon glyphicon-trash"></span> <?php echo lang('list_delete'); ?></a></td>
                </tr>
                <?php } ?>
