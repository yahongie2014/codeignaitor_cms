      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <ul class="breadcrumb">
            ...
            <?php ?>   <li class="active"><?php echo  lang('gallery');?></li><?php ?>
         ...
         <section class="panel">
          <header class="panel-heading">
            ...
            <div class="pull-right">
              ...
              <a class="btn btn-sm btn-default" href="<?php echo base_url().'admin/videos/form'; ?>"><span class="glyphicon glyphicon-plus"></span> <?php echo lang('form_add'); ?></a>
          ...
          <form class='cmxform form-horizontal tasi-form'  id='form11' method='post' action="<?php echo base_url() . 'admin/videos/delete' ?>">
            <table class="table table-striped border-top" id="sample_1">
              ...
              <tbody>
               ...
               <tr class="odd gradeX">
                ...
                <td>
                  <a class="btn btn-sm btn-info" href="<?php echo base_url().'admin/videos/form/'.$item->id; ?>"><span class="glyphicon glyphicon-cog"></span> <?php echo lang('edit'); ?></a>

                  <a class="btn btn-sm btn-success" href="<?php echo base_url().'admin/videos/data/'.$item->id; ?>"><span class="glyphicon glyphicon-picture"></span> <?php echo lang('videos'); ?></a>

                  <a class="btn btn-sm btn-danger" href="<?php echo base_url().'admin/videos/delete/'.$item->id; ?>"  onClick="return Del_Confirm(); "><span class="glyphicon glyphicon-trash"></span> <?php echo lang('list_delete'); ?></a></td>
                </tr>
                <?php } ?>
