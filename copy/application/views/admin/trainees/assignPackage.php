          ...
          <div class="panel-body">
            ...
            <div class="tab-content">
                ...
                <div class="form-group coursesDiv">
                  <label for="courseId" class="control-label col-lg-2"><?php echo lang( 'packages' ); ?>  *</label>
                  <div class="col-lg-6">
                    <select name="courseId" id="courseId" class=" form-control" >
                          <option value="#" selected="selected"><?php echo lang('choose'); ?></option>
                          <?php if(!empty($packages)) {
                            foreach ($packages as $wr) { ?>
                            <option value="<?php echo $wr->id; ?>" <?php if(!empty($returnedData)  && ($wr->id == $packageId)) echo "selected"; ?> ><?php echo $wr->title; ?></option>
                            <?php }//foreach
                          }//if packages ?>
                    </select>
                  </div>
...
$(document).ready(function() {
    ...
    $('#courseId').change(function() { //any select change on the dropdown with id language trigger this code
        ...
        var url = "<?php echo base_url(); ?>admin/trainees/get_course_data/" + courseId+'/package' ;
        // alert(url);
        $.ajax({
            type: "POST",
            dataType: 'json',
