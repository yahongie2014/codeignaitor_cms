        ...
        <div class="col-lg-12">
          ...
          <ul class="breadcrumb">
            ...
            <li><a href="<?php echo base_url().'admin/albums/'; ?>"><?php echo lang( 'albums' ); ?></a></li>
               ...
               <li class="active"><?php echo  lang('images'); ?></li>
          </ul>
          <!--breadcrumbs end -->
        </div>
      </div>
         ...
         <section class="panel">
          <header class="panel-heading">
            ...
            <div class="pull-right">
              <a class="btn btn-sm btn-default" href="<?php echo base_url().'admin/albums/imageForm/'.$galleryId; ?>"><span class="glyphicon glyphicon-plus"></span> <?php echo lang('form_add'); ?></a>
            </div>
          </header>
            ...
            <table class="table table-striped border-top" id="sample_1">
              <thead>
                <tr>
                  ...
                  <th class="hidden-phone"><?php echo lang('image'); ?></th>
              ...
              <tbody>
               ...
               <tr class="odd gradeX">
                ...
                <td>
                    ...
                    <?php if ( $item->fileName!="" && file_exists( "$filename" ) ) { ?>
                ...
                <td>
                  <a class="btn btn-sm btn-info" href="<?php echo base_url().'admin/albums/imageForm/'.$galleryId.'/'.$item->id; ?>"><span class="glyphicon glyphicon-cog"></span> <?php echo lang('edit'); ?></a>

                  <a class="btn btn-sm btn-danger" href="<?php echo base_url().'admin/albums/delete/'.$item->id.'/image/'.$galleryId; ?>"  onClick="return Del_Confirm(); "><span class="glyphicon glyphicon-trash"></span> <?php echo lang('list_delete'); ?></a></td>
                </tr>
                <?php } ?>
