    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ul class="breadcrumb">
          ...
          <li><a href="<?php echo base_url().'admin/ourTeam/'; ?>"><?php echo lang( 'ourTeam' ); ?></a></li>
    ...
    <div class="row">
      <div class="col-lg-12">
        <section class="panel">
         <!-- Form Start -->
         <div class="form">
           <form class="cmxform form-horizontal tasi-form" id="signupForm" enctype="multipart/form-data" method="post" action="<?php echo site_url( 'admin/ourTeam/form/'.$id); ?>">
            <!-- tabbed header -->
          ...
          <!-- tabbed content -->
            ...
            <div class="panel-body">
                ...
                <div class="tab-content">
                    ...
                    <div id="home-36" class="tab-pane active">
                        ...
                        <div class="form-group ">
                          <label  class="control-label col-lg-2"><?php echo lang( 'Name' ); ?>   *</label>
                          <div class="col-lg-6">
                ...
                <div class="form-group ">
                    ...
                    <?php  if(!empty($image)){ ?>
                    <?php $filename = "application/views/images/upload/ourTeam/".$image; ?>
                        <div class="col-lg-6">
              ...
              <div class="col-lg-12 bottom-form-update">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-offset-9 col-lg-3">
                    ...
                    <button class="btn btn-danger" type="button" onclick="window.location = '<?php echo site_url('admin/ourTeam'); ?>'"><?php echo lang( 'Cancel' ); ?></button>
