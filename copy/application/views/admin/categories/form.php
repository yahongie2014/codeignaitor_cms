    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ul class="breadcrumb">
          ...
          <li><a href="<?php echo base_url().'admin/categories/'; ?>"><?php echo lang( 'categories' ); ?></a></li>
      ...
      <div class="col-lg-12">
        <section class="panel">
         ...
         <div class="form">
           ...
           <form class="cmxform form-horizontal tasi-form" id="signupForm" enctype="multipart/form-data" method="post" action="<?php echo site_url( 'admin/categories/form/'.$id); ?>">
            ...
            <div class="col-lg-12 bottom-form-update">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-offset-9 col-lg-3">
                  ...
                  <button class="btn btn-danger" type="button" onclick="window.location = '<?php echo site_url('admin/categories'); ?>'"><?php echo lang( 'Cancel' ) ?></button>
