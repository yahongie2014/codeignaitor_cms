         ...
         <div class="panel-body">
          ...
          <div id="divMessage" class="<?php echo $this->session->flashdata( 'msg_class' );?>" >
           ...
           <?php if(!empty($message)) echo $message; ?>
              ...
              <form class="form-horizontal" method='post' action="<?php echo base_url() . 'newsFeed/rssWebsites/'.$ID; ?>">
               ...
               <thead>
                <tr>
                 ...
                 <th><?php echo lang('url'); ?></th>
                  <th class="hidden-phone"><?php echo lang('addUsername'); ?></th>
                  <th class="hidden-phone"><?php echo lang('addingDate'); ?></th>
                  <th class="hidden-phone"><?php echo lang('modifyUsername'); ?></th>
             ...
             <tbody>
               ...
               <tr class="odd gradeX">
                ...
                <td><?php  if(!empty($item->modifyUsername)) echo $item->modifyUsername; ?></td>
                <td><?php  if(!empty($item->lastModifiedDate)) echo $item->lastModifiedDate; ?></td>
                <td>
                  <a class="btn btn-sm btn-info" href="<?php echo base_url().'newsFeed/index/'.$item->id; ?>"><span class="glyphicon glyphicon-cog"></span> <?php echo lang('edit'); ?></a>
                  <a class="btn btn-sm btn-danger" href="<?php echo base_url().'newsFeed/deleteWebsite/'.$item->id; ?>"  onClick="return Del_Confirm(); "><span class="glyphicon glyphicon-trash"></span> <?php echo lang('list_delete'); ?></a>
                </td>
                </tr>
                <?php } ?>
             </tbody>
