         ...
         <section class="panel">
          <header class="panel-heading">
            ...
            <div class="pull-right">
              <a class="btn btn-sm btn-warning" href="<?php echo base_url().'admin/courses/excelApplications/'.$courseId; ?>"><span class="glyphicon"></span> <?php echo lang('export_excel'); ?></a>
            </div>
          </header>
            ...
            <table class="table table-striped border-top" id="sample_1">
              ...
              <tbody>
               ...
               <tr class="odd gradeX">
                ...
                <td>
                  <a class="btn btn-sm btn-info" href="<?php echo base_url().'admin/trainees/assign/'.$item->applicationsId.'/'.$item->traineeId; ?>" ><span class="glyphicon glyphicon-cog"></span> <?php echo lang('edit'); ?></a>
                  <a class="btn btn-sm btn-danger" href="<?php echo base_url().'admin/courses/deleteApplication/'.$item->applicationsId.'/'.$item->traineeId.'/'.$item->courseId; ?>"  onClick="return Del_Confirm(); "><span class="glyphicon glyphicon-trash"></span> <?php echo lang('list_delete'); ?></a>
                </td>
                <?php } //if admin ?>
                </tr>
                <?php } ?>
