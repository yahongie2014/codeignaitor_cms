...
*/
	 ...
	 */
	$config['site_title']		   = "food.com";
	
	/**
	 * Admin Email, admin@example.com
	 */
	$config['admin_email']		   = "admin@food.com";
     ...
     * Default : auth/
	 **/
	$config['email_templates']     = 'front/auth/email/';
...
/* End of file admin_ion_auth.php */
/* Location: ./system/application/config/admin_ion_auth.php */
