...
class Application_model extends CI_Model {
    ...
    public function getCoursesApplications($where = NULL) {
        $this->db->select('applications.*, applications.id as applicationsId, trainees.name, trainees.email, trainees.phone, trainees.college_work, trainees.placementTest');
        $this->db->from(self::TABLE_NAME);
