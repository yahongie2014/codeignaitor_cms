...
class Event_model extends CI_Model {
    ...
    public function getWithLanguage($where = NULL, $language) {
        ...
        {
            $this->db->select('*, titleGE as title, contentGE as content, locationGE as location');
        }
        else
        {
            $this->db->select('*, titleAR as title, contentAR as content, locationAR as location');
        }
        $this->db->from(self::TABLE_NAME);
        if ($where !== NULL) {
            if (is_array($where)) {
    ...
    public function delete($where = array()) {
        ...
        {
          $res = $query->row();
          $file = 'application/views/images/upload/events/'.$res->image;
