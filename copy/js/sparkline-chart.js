...
//sparkline chart
    ...
    $("#barchart2").sparkline([5,3,6,7,5,6,4,2,3,4,6,8,9,10,8,6,5,7,6,5,4,7,4,5,7,3,5,2], {
        type: 'bar',
        height: '200',
        barWidth: 12,
        barSpacing: 6,
...
//            '<span style="color: {{color}}">&#9679;</span> {{offset:names}} ({{percent.1}}%)</span>'
    ...
    $("#barchart").sparkline([1243,2326,227,215,605,632,0,0,855,125,968,250,833,658,557,850,865,775,222,111,888,123,323,888,434,3434,3434,213,323,888], {
        type: 'bar',
        height: '200',
        barWidth: 12,
        barSpacing: 6,
